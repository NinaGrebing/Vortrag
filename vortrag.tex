...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				\item \textbf{Model:} Teilgebiet, Simulation, Polynom
				\item \textbf{View:} Eingabe, Ausgabe
				\item \textbf{Controller:} Simulationsabwicklung
			\end{itemize}
		\end{column}
			\begin{column}{0.5\textwidth}
				\begin{figure}
%					\includegraphics[width=10cm]{./uml-diagramm.jpg}
				\end{figure}
			\end{column}
	\end{columns}
\end{frame}
